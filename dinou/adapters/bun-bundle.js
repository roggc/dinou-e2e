// dinou/adapters/bun-bundle.js
// Native Bun Pre-Bundled Adapter for Dinou v7.
...
if (fs.existsSync(bundlePath)) {
  try {
    ...
    console.error("[Dinou Bun Bundle Adapter] Failed to load .dinou/bun/server.js:", e);
  }
}
...
export async function fetch(req) {
  ...
  return new Response(
    "Dinou Bun bundle not found. Please run 'npm run build:bun:bundle' first.",
    {
      status: 500,
